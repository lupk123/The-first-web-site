...
$page_num = 15;
global $page_start;
page($page_num, query("SELECT tg_id FROM tg_message WHERE tg_touser = '{$_COOKIE['username']}'"));//每页显示$page_num个//从数据库里提取数据

$result = query("SELECT tg_id, tg_fromuser ,tg_content, tg_state, tg_date FROM tg_message WHERE tg_touser = '{$_COOKIE['username']}' ORDER BY tg_date DESC LIMIT $page_start, $page_num");
		...
		<div id = "member">
			...
			<div id = "member_main">
				...
				<form method='post' action="?action=delete">
					<table cellspacing = '0'>		
					<tr><th>发信人</th><th>短信内容</th><th>收信时间</th><th>状态</th><th>操作</th></tr>			
						...
						?>
							<tr>
								...
								<td><a href = 'message_detail.php?state=receive&id=<?php echo $cc['tg_id'];?>' title = "<?php $cc['tg_content'];?>"><?php echo $strong;?></a></td>
