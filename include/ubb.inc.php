...
?>
<div id = "ubb">
	<img src = 'image/1/indent.gif' title = '缩进' alt = '加粗'/>
	<img src = 'image/1/bold.gif' title = '加粗' alt = '加粗'/>
	<img src = 'image/1/italic.gif' title = '倾斜' alt = '加粗'/>
	<img src = 'image/1/underline.gif' title = '下划线' alt = '加粗'/>
	<img src = 'image/1/removeformat.gif' title = '取消效果' alt = '取消文字效果'/> 
	<img src = 'image/1/color.gif' title = '字体颜色' alt = '字体颜色'/>
	<img src = 'image/1/separator.gif' title = '线条' alt = '线条'/>
	<img src = 'image/1/createlink.gif' title = '链接' alt = '加粗'/>						
	<img src = 'image/1/insertimage.gif' title = '插入图片' alt = '加粗'/>						
	<img src = 'image/1/justifyleft.gif' title = '居左' alt = '加粗'/>
	<img src = 'image/1/justifycenter.gif' title = '居中' alt = '加粗'/>
	<img src = 'image/1/justifyright.gif' title = '居右' alt = '加粗'/>						
	<img src = 'image/1/email.gif' title = '邮箱' alt = '加粗'/>
	<img src = 'image/1/quote.gif' title = '引用' alt = '加粗'/>
	<img src = 'image/1/outdent.gif' title = '取消缩进' alt = '加粗'/>
	<img src = 'image/1/separator.gif' title = '线条' alt = '线条'/>
	<img src = 'image/1/resize_0.gif' title = '增大文本框' alt = '加粗'/>
	<img src = 'image/1/resize_1.gif' title = '减小文本框' alt = '加粗'/>
	<img src = 'image/1/code.gif' title = '代码' alt = '加粗'/>
	<img src = 'image/1/insertorderedlist.gif' title = '项目' alt = '加粗'/>
	<img src = 'image/1/insertunorderedlist.gif' title = '项目列表' alt = '加粗'/>
</div>
<div id = 'font'>
...
<div id = 'color'>
	...
	<strong title = '橄榄绿' style = "background: #330" onclick = "showcolor('#330');"></strong>
	...
	<strong title = '靛蓝' style = "background: #339" onclick = "showcolor('#339');"></strong>
	...
	<strong title = '青旅' style = "background: #0ff" onclick = "showcolor('#0ff');"></strong>
	<strong title = '天蓝' style = "background: #0cf" onclick = "showcolor('#0cf');"></strong>
	<strong title = '玫红' style = "background: #936" onclick = "showcolor('#936');"></strong>
